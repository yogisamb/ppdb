<section class="my-5 container containers">
  <h2 class="text-center mb-4">Pendaftaran (Buku Tamu) Peserta Didik Baru</h2>
  <form action="<?= base_url('welcome/pendaftaran'); ?>" method="post" class="p-5 bg-white" enctype="multipart/form-data">
    <div class="card-header py-3">
      <h6>Isi Data Dibawah ini Untuk Melengkapi Buku Tamu Peserta Didik Baru</h6>
    </div>
    ...
    <div class="row form-group">
      <div class="col-md-12  mb-3">
        <label class="form-label form_label" for="email">Jadwal Observasi</label>
        <input type="date" id="jadwal" name="jadwal" class="form-control" placeholder="Jadwal Observasi" value="<?= set_value('jadwal'); ?>"> <?= form_error('jadwal', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
    </div>
    ...
    <div class="row form-group">
      <div class="col-md-12  mb-3">
        ...
        <div class="row">
          <div class="col-md-6"><input type="email" id="email" name="email" class="form-control" placeholder="Email Bapak / Ibu" value="<?= set_value('email'); ?>"> <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?></div>
          <div class="col-md-6"><input type="text" id="password" name="password" class="form-control" placeholder="Password untuk aplikasi" value="<?= set_value('password'); ?>"> <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?></div>
        </div>
      </div>
    </div>
    ...
    <div class="row form-group">
      <div class="col-md-12  mb-3">
        <label class="form-label form_label" for="message">Keterangan Lain</label>
    ...
    <div class="row form-group">
      <div class="col-md-12 mb-3">
        <label class="form-label form_label" for="fname">Darimana Ayah Bunda memperoleh informasi PPDB SD Islam Bintang Juara?</label>
    ...
    <div class="row form-group">
      <div class="col-md-12 mb-3">
        <label class="form-label form_label" for="message">Pertanyaan Seputar PPDB</label>
